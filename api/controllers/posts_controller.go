...
import (
	...
	"github.com/immanoj16/fullstack/api/utils/formaterror"
)

// CreatePost used to create a new post
...
// GetPosts used to get all the posts
...
// GetPost used to get an existing post
...
// DeletePost used to delete an existing post
