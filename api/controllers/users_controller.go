...
// GetUsers used to get all the users
...
// GetUser used to get existing user with id
...
// UpdateUser used to update an existing user
...
// DeleteUser used to delete an existing user
